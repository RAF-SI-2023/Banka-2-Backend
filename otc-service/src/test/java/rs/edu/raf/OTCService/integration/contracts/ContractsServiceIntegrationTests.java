...
@SelectClasspathResource("features/integration/contracts")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "rs.edu.raf.OTCService.integration.contracts")
public class ContractsServiceIntegrationTests {
